...
export class DevicesManagerComponent {
  ...
  displayedColumns: { columnId: string, columnName: string }[] = [
    ...
    { columnId: 'name', columnName: 'Nombre / IP' },
  ...
  dataSource = new MatTableDataSource<any>([
    { id: 1, name: 'XP-80C', area: 'Kiosco', desc: 'Impresora del kiosco', status: 'Habilitado' },
    ...
    { id: 7, name: 'Samsung-CLP-365W', area: 'Soporte', desc: 'Impresora del equipo de soporte', status: 'Deshabilitado' },
    { id: 8, name: 'Lexmark-MS431dn', area: 'Dirección', desc: 'Impresora de la dirección', status: 'Habilitado' },
    
    // Nuevos datáfonos
    { id: 9, name: 'Verifone-VX680', area: 'Kiosco', desc: 'Datáfono del kiosco', status: 'Habilitado' },
    { id: 10, name: 'Ingenico-iWL250', area: 'Kiosco', desc: 'Datáfono del kiosco', status: 'Habilitado' },
    { id: 11, name: 'Pax-S920', area: 'Kiosco', desc: 'Datáfono del kiosco', status: 'Habilitado' },
    { id: 12, name: 'Verifone-VX520', area: 'Kiosco', desc: 'Datáfono del kiosco', status: 'Habilitado' }
